import type { Context, Middleware, Transformer } from "npm:grammy@1";
/**
 ...
 */ export function addReplyParam<C extends Context>(ctx: C, options?: Partial<AutoQuoteOptions>): Transformer;
/**
